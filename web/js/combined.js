...
// Home Featured, Standard Layout
    ...
    $(document).on('click', '.like-documentary .like, .like-documentary .liked', function(e){
        ...
        $.ajax({
            type: 'POST',
            url: 'http://www.documentarywire.com/ajax/like/documentary',
            data: data,
            dataType: 'json',
            error: function(){
    ...
    $(document).on('click', '.comment-vote .upvote, .comment-vote .downvote', function(e){
        var el = $(this);
        el.prop('disabled', true);
        ...
        var data = {
            action: actionType,
            commentId: el.attr("data-cid")
        };

        $.ajax({
            type: 'POST',
            url: 'http://www.documentarywire.com/ajax/comment/vote',
            data: data,
            dataType: 'json',
            error: function(){
                alert('Error. please log in.');
            ...
            success: function(r){
                ...
                alert(r.points);
                alert(actionType);
                $('.comment-vote').each(function(){
                    var comment = $(this);
                    if(comment.attr('data-cid') == el.attr('data-cid')) {
                        var points = $(this).find('.points');
                        var amount = parseInt(points.text()) + (r.points);
                        $(points).text(amount);
                    }
                });
                el.prop('disabled', false);
